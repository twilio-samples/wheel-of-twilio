...
DEFAULT_RESOURCE_GROUP="${DEFAULT_RESOURCE_GROUP:-rg-wheel-of-twilio}"
DEFAULT_APP_NAME="${DEFAULT_APP_NAME:-wheel-of-twilio}"
DEFAULT_ENV_NAME="${DEFAULT_ENV_NAME:-cae-wheel-of-twilio}"
DEFAULT_IMAGE_NAME="${DEFAULT_IMAGE_NAME:-wheel-of-twilio}"
